        ...
        <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-6xl flex-col">
          <div className="flex items-center justify-between rounded-[28px] border border-white/50 bg-background/75 px-5 py-4 shadow-panel backdrop-blur">
            <div className="flex items-center gap-3">
              <LogoMark />
              <div>
                <p className="text-sm text-muted-foreground">Algotrade X</p>
                <h1 className="font-semibold">Invest Smart. Invest Safe.</h1>
              </div>
            </div>
          ...
          <div className="grid flex-1 items-center gap-10 py-10 lg:grid-cols-[1.1fr_0.9fr] lg:py-16">
            ...
            >
              ...
              <h2 className="max-w-3xl text-5xl font-bold tracking-tight text-slate-950 dark:text-white md:text-7xl">
